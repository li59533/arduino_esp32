 ...
 *  STATIC VARIABLES
 **********************/
TFT_eSPI tft = TFT_eSPI(MY_DISP_VER_RES, MY_DISP_HOR_RES); /* TFT instance */
...
void lv_port_disp_init(void)
{
    ...
    // lv_color_t *buf1 =(lv_color_t *) heap_caps_malloc(MY_DISP_HOR_RES * 20 * sizeof(lv_color_t), MALLOC_CAP_DMA);
    // assert(buf1);
    // lv_color_t *buf2 =(lv_color_t *) heap_caps_malloc(MY_DISP_HOR_RES * 20 * sizeof(lv_color_t), MALLOC_CAP_DMA);
    // assert(buf2);
