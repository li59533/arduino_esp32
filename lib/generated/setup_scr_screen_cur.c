...
void setup_scr_screen_cur(lv_ui *ui)
{
	...
	lv_obj_set_style_bg_color(ui->screen_cur, lv_color_hex(0x0093ff), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_cur_label_setcur, &my_font, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_cur_label_realcur, &my_font, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_cur_label_status, &my_font, LV_PART_MAIN|LV_STATE_DEFAULT);
